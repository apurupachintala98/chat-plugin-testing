...
var IconContext$1 = React__default["default"].createContext && /*#__PURE__*/React__default["default"].createContext(DefaultContext$1);
...
function Tree2Element$1(tree) {
  return tree && tree.map((node, i) => /*#__PURE__*/React__default["default"].createElement(node.tag, _objectSpread$1({
    key: i
  }, node.attr), Tree2Element$1(node.child)));
}
function GenIcon$1(data) {
  return props => /*#__PURE__*/React__default["default"].createElement(IconBase$1, _extends$2({
...
function IconBase$1(props) {
  ...
  return IconContext$1 !== undefined ? /*#__PURE__*/React__default["default"].createElement(IconContext$1.Consumer, null, conf => elem(conf)) : elem(DefaultContext$1);
}
...
const processChildren = (children, outline, pill) => {
  return React.Children.map(children, (child, index) => {
    if (React.isValidElement(child)) {
      const positionInGroupProp = child.type == Button ? { positionInGroup: determinePosition(index, React.Children.count(children)) } : {};
...
const FocusGuard = /*#__PURE__*/React__namespace.forwardRef(function FocusGuard(props, ref) {
  ...
  return /*#__PURE__*/React__namespace.createElement("span", _extends$1({}, props, restProps));
});
...
const VisuallyHiddenDismiss = /*#__PURE__*/React__namespace.forwardRef(function VisuallyHiddenDismiss(props, ref) {
  return /*#__PURE__*/React__namespace.createElement("button", _extends$1({}, props, {
    type: "button",
    ref: ref,
    tabIndex: -1,
    style: HIDDEN_STYLES
...
const DatepickerRender = ({
  ...
  const [view, setView] = React.useState(Views.Days);
...
function useCurrentColorScheme(options) {
  ...
  const [, setHasMounted] = React__namespace.useState(false);
...
const ChatMessage = _ref => {
  ...
  }, chatLog.map((chat, index) => /*#__PURE__*/React__default["default"].createElement(material.Box, {
    key: index,
    sx: {
      display: 'flex',
  ...
  }, chat.role === 'assistant' ? /*#__PURE__*/React__default["default"].createElement(material.Box, {
    sx: {
      display: 'flex',
      alignItems: 'center'
    }
  ...
  }, chat.content)) : /*#__PURE__*/React__default["default"].createElement(material.Box, {
    sx: {
      display: 'flex',
      alignItems: 'center'
    }
  ...
  }, chat.content), /*#__PURE__*/React__default["default"].createElement(material.Avatar, {
    src: user,
    alt: "User",
    sx: {
      borderRadius: '50%',
...
function UserChat(props) {
  ...
  const isMediumScreen = material.useMediaQuery(theme.breakpoints.between('sm', 'md'));
  const {
    chatLog,
    setChatLog,
    themeColor,
  ...
  const [apiResponse, setApiResponse] = React.useState(null); // New state for storing API response
  const [appCd, setAppCd] = React.useState('Chat_Bot'); // User input for app_cd
  const [input, setInput] = React.useState('');
  const layoutWidth = isSmallScreen ? '100%' : isMediumScreen ? '80%' : '70%';
  const inactivityTimeoutRef = React.useRef(null); // Ref for the inactivity timeout
  const [sessionActive, setSessionActive] = React.useState(true); // State to track session activity
  ...
  return /*#__PURE__*/React__default["default"].createElement(material.Box, {
  ...
  }, showInitialView && /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement("div", {
    style: {
      width: '40px',
      height: 'auto',
      overflow: 'hidden',
  ...
  }, "Hello there, I am your Chat Assistant. How can I help you today?")), /*#__PURE__*/React__default["default"].createElement(material.Box, {
    sx: {
      flex: 1,
      width: '100%',
      overflowY: 'auto',
  ...
  }, /*#__PURE__*/React__default["default"].createElement(ChatMessage, {
    chatLog: chatLog
  }), /*#__PURE__*/React__default["default"].createElement("div", {
    ref: endOfMessagesRef
  }), isLoading && /*#__PURE__*/React__default["default"].createElement(HashLoader, {
    color: "#1a3673",
    size: 30,
    "aria-label": "Loading Spinner",
    "data-testid": "loader"
  }), successMessage && /*#__PURE__*/React__default["default"].createElement(Alert, {
    color: "success"
  }, /*#__PURE__*/React__default["default"].createElement("span", {
    className: "font-medium"
  }, successMessage))), /*#__PURE__*/React__default["default"].createElement(material.Box, {
    sx: {
      display: 'flex',
    ...
    InputProps: {
      ...
      endAdornment: /*#__PURE__*/React__default["default"].createElement(material.InputAdornment, {
        ...
        type: "submit"
      }, /*#__PURE__*/React__default["default"].createElement(FaTelegramPlane, {
        className: "h-6 w-6",
        color: themeColor
      })))
    }
  }))))), /*#__PURE__*/React__default["default"].createElement(material.Modal, {
    open: openPopup,
  ...
  }, /*#__PURE__*/React__default["default"].createElement(material.Fade, {
    in: openPopup
  }, /*#__PURE__*/React__default["default"].createElement(material.Box, {
    sx: {
      position: 'absolute',
    ...
    variant: "h6",
    component: "h2"
  }, "Session Ended"), /*#__PURE__*/React__default["default"].createElement(material.Typography, {
    sx: {
      mt: 2
    }
...
const Dashboard = () => {
  const isMobile = material.useMediaQuery("(max-width:950px)");
  // Lift the states up from UserChat
  const [chatLog, setChatLog] = React.useState([]); // Chat log state
  const [responseReceived, setResponseReceived] = React.useState(false); // Hide helpfulness prompt
  const [error, setError] = React.useState(''); // Error message state
  const [isLoading, setIsLoading] = React.useState(false); // Loading indicator
  const [successMessage, setSuccessMessage] = React.useState(''); // New state for success message
  const [themeColor, setThemeColor] = React.useState("#1a3673"); // Default theme color
  const [requestId, setRequestId] = React.useState(v4());
  ...
  return /*#__PURE__*/React__default["default"].createElement(ThemeProvider, {
  ...
  }, /*#__PURE__*/React__default["default"].createElement(material.CssBaseline, null), /*#__PURE__*/React__default["default"].createElement(material.AppBar, {
    position: "fixed",
    sx: {
  ...
  }, /*#__PURE__*/React__default["default"].createElement(material.Toolbar, {
    sx: {
  ...
  }, "Chat Assistant"))), !isMobile && /*#__PURE__*/React__default["default"].createElement(material.Drawer, {
    variant: "permanent",
    sx: {
      width: drawerWidth,
      flexShrink: 0,
  ...
  }, /*#__PURE__*/React__default["default"].createElement(material.Toolbar, null), /*#__PURE__*/React__default["default"].createElement(material.Box, {
    sx: {
      position: "relative",
      height: "100%",
      padding: 2,
    ...
    startIcon: /*#__PURE__*/React__default["default"].createElement(HiOutlinePencilAlt, null),
    onClick: handleNewChat
  }, "New Chat"))), /*#__PURE__*/React__default["default"].createElement(material.Box, {
    component: "main",
    sx: {
      flexGrow: 1,
      bgcolor: "#fff",
  ...
  }, /*#__PURE__*/React__default["default"].createElement(material.Toolbar, null), isMobile && /*#__PURE__*/React__default["default"].createElement(material.Box, {
    sx: {
      display: "flex",
      justifyContent: "center",
      marginBottom: 2
  ...
  }, /*#__PURE__*/React__default["default"].createElement(UserChat, {
    chatLog: chatLog,
